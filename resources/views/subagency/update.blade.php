...
<div class="box box-primary">
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form role="form" action="{{route('subagency.update',$agency->id)}}" method="POST" >
      ...
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <input type="hidden" class="form-control" id="" name="p_agency_id" value="{{$agency->parent_agency_id}}">
